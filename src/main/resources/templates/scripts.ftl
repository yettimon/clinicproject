...
<script  type='text/javascript' src="<@spring.url 'https://cdn.datatables.net/1.10.21/js/dataTables.bootstrap4.min.js'/>"></script>
...
<script  type='text/javascript' src="<@spring.url 'https://cdnjs.cloudflare.com/ajax/libs/Chart.js/2.8.0/Chart.min.js' />"></script>
<script  type='text/javascript' src="<@spring.url '/js/scripts.js' />"></script>
<script  type='text/javascript' src="<@spring.url '/assets/demo/datatables-demo.js' />"></script>
<script  type='text/javascript' src="<@spring.url '/assets/demo/chart-area-demo.js' />"></script>
<script  type='text/javascript' src="<@spring.url '/assets/demo/chart-bar-demo.js' />"></script>
